...
*/
    ...
    lv_obj_t * finelogo_icon;
    finelogo_icon = lv_img_create(screen, NULL);
    lv_img_set_src(finelogo_icon, &finelogo);
    lv_obj_align(finelogo_icon, NULL, LV_ALIGN_IN_TOP_MID, 0,0);
